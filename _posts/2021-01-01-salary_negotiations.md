...
[**Примечание переводчика:** разумеется, когда ниже речь идёт о конкретных цифрах, мы должны помнить, что речь о годовой зарплате (annual salary или просто salary).]
