...
В нем будет такой код:

```
  <h3>this is our second project</h3>
```
...
Не забудьте заменить `111.111.111.111` на ip-адрес вашего сервера. Сохраните файл (это потребует прав администратора) и откройте в браузере http://first.com. Вы должны увидеть следующий текст, написанный крупным шрифтом:

```
this is our first project
```

Если вы увидели созданную вами в самом начале страницу, то поздравляю, у вас все получилось! Если нет, вернитесь назад и поищите, где же вы были невнимательным (со мной это постоянно случается). Таким же образом проверьте второй хост, перейдя в браузере по адресу http://second.com. Здесь вы должны увидеть текст, написанный шрифтом чуть меньшего размера, чем на предыдущей странице:
